...
public enum StandardField implements Field {
    ...
    USERNAME("username", FieldProperty.PERSON_NAMES),
    USERNOTE("usernote", FieldProperty.COMMENT, FieldProperty.MULTILINE_TEXT, FieldProperty.VERBATIM, FieldProperty.MARKDOWN),
    USERSUMMARY("summary", FieldProperty.COMMENT, FieldProperty.MULTILINE_TEXT, FieldProperty.VERBATIM, FieldProperty.MARKDOWN),
    VENUE("venue"),
    VERSION("version"),
